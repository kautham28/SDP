    ...
    <div className="rep-settings-page-container">
      ...
      <div className="rep-settings-main-content">
        ...
        <div className="rep-settings-profile-content">
          <h1 className="rep-settings-title">Personal Information</h1>
          <div className="rep-settings-profile-container">
            <div className="rep-settings-profile-picture-container">
              ...
              {isEditing && (
                <input
                  ...
                  className="rep-settings-input-file"
                />
              )}
            </div>
            <div className="rep-settings-fields">
              <div className="rep-settings-column">
                <div className="rep-settings-field">
                  <label>Name</label>
                  {isEditing ? (
                    <input
                      type="text"
                    ...
                    <p className="rep-settings-value">{user.name}</p>
                  )}
                </div>
                <div className="rep-settings-field">
                  <label>ID</label>
                  <p className="rep-settings-value">{user.id}</p>
                </div>
                <div className="rep-settings-field">
                  ...
                  {isEditing ? (
                    ...
                    <p className="rep-settings-value">{user.date_of_birth}</p>
                  )}
                </div>
                <div className="rep-settings-field">
                  ...
                  {isEditing ? (
                    ...
                    <p className="rep-settings-value">{user.telephone}</p>
                  )}
                </div>
                {isEditing && (
                  <div className="rep-settings-field">
              ...
              <div className="rep-settings-column">
                <div className="rep-settings-field">
                  ...
                  {isEditing ? (
                    ...
                    <p className="rep-settings-value">{user.nic_number}</p>
                  )}
                </div>
                <div className="rep-settings-field">
                  <label>Role</label>
                  <p className="rep-settings-value">Representative</p>
                </div>
                <div className="rep-settings-field">
                  ...
                  {isEditing ? (
                    ...
                    <p className="rep-settings-value">{user.email}</p>
                  )}
                </div>
                <div className="rep-settings-field">
                  ...
                  {isEditing ? (
                    ...
                    <p className="rep-settings-value">{user.residentAddress}</p>
                  )}
                </div>
              </div>
            </div>
            <button
              ...
              className="rep-settings-edit-button"
            >
